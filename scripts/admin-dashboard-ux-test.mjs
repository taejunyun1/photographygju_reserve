...
const { state } = await import("../public/js/state.js?v=20260921-studio-report-r1");
const { adminShell, adminDashboardView, adminSettingsView, adminDashboardMetrics, adminReservationsView, adminReportsView, adminLecturesView, adminNoticesView, adminEquipmentView, adminUsersView, adminLogsView } = await import("../public/js/views-admin.js?v=20260921-studio-report-r1");
const { plannedAdminNotifications } = await import("../public/js/native-notifications.js?v=20260921-studio-report-r1");
const { captureScrollState, restoreScrollState } = await import("../public/js/events/scroll-state.js?v=20260921-studio-report-r1");
