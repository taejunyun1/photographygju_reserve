...
const { state: bridgeState } = await import("../public/js/state.js?v=20260704-student-icon-nav");
...
const { loadMe } = await import("../public/js/data.js?v=20260704-student-icon-nav");
