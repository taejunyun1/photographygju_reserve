...
const { state: bridgeState } = await import("../public/js/state.js?v=20260921-studio-report-r1");
...
const { loadMe } = await import("../public/js/data.js?v=20260921-studio-report-r1");
