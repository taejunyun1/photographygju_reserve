  ...
  return (
    <section className="grid student-react-reports">
      ...
      <GjuCard title="보고서 제출 기한">
        ...
        {driveUrl ? <a className="button primary compact" href={driveUrl} target="_blank" rel="noopener noreferrer">구글 드라이브 열기</a> : <GjuStatusBadge tone="amber">드라이브 링크 등록 필요</GjuStatusBadge>}
      </GjuCard>
