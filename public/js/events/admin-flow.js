...
import { api } from "../api.js?v=20260923-reservation-requests-r1";
import { loadAdminData, loadBootstrap } from "../data.js?v=20260923-reservation-requests-r1";
import { downloadAdminBackup, downloadLectureCsv, logout } from "../actions.js?v=20260923-reservation-requests-r1";
import {
  patchAdminEquipment,
  syncAdminEquipmentDom
} from "../admin-equipment.js?v=20260923-reservation-requests-r1";
import { render, toast } from "../renderer.js?v=20260923-reservation-requests-r1";
import { formData, parseCsv } from "../utils.js?v=20260923-reservation-requests-r1";
import {
  captureScrollState,
  ...
  resetAdminPage,
  setAdminPage
} from "./shared.js?v=20260923-reservation-requests-r1";
...
function currentBulkDeleteConfig(kind, scope) {
  if (kind === "reservations") {
    ...
    const filters = {
      ...
      status: !query && (state.adminReservationTab === "equipment" || ["cancelled_or_rejected", "operational"].includes(state.adminEquipmentReservationStatusFilter))
        ? state.adminEquipmentReservationStatusFilter
        : "",
