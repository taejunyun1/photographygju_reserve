...
import { loadAdminData, loadBootstrap, loadLectures, loadMe, loadMyReservations } from "./data.js?v=20260614-logs1";
import { setupEventHandlers } from "./events.js?v=20260614-logs1";
import { render } from "./renderer.js?v=20260614-logs1";
