...
import { loadAdminData, loadBootstrap, loadLectures, loadMe, loadMyReservations } from "./data.js?v=20260613-studioflow1";
import { setupEventHandlers } from "./events.js?v=20260613-studioflow1";
import { render } from "./renderer.js?v=20260613-studioflow1";
