...
import { loadAdminData, loadBootstrap, loadLectures, loadMe, loadMyReservations } from "./data.js?v=20260616-feat1";
import { setupEventHandlers } from "./events.js?v=20260616-feat1";
import { render } from "./renderer.js?v=20260616-feat1";
