import { $app, state } from "./state.js?v=20260923-reservation-requests-r1";
import { api, apiBinary } from "./api.js?v=20260923-reservation-requests-r1";
import {
  ...
  loadLectures,
  loadMyReservations
} from "./data.js?v=20260923-reservation-requests-r1";
...
} from "./native-notifications.js?v=20260923-reservation-requests-r1";
import { createStudentReactActions, studentReactSnapshot } from "./react-student-adapter.js?v=20260923-reservation-requests-r1";
import { csvEscape, escapeHtml, formatDateTime, todayKey } from "./utils.js?v=20260923-reservation-requests-r1";
import { adminShell } from "./views-admin.js?v=20260923-reservation-requests-r1";
import { authView, noticeBottomSheet, studentShell, warningPopup } from "./views-student.js?v=20260923-reservation-requests-r1";
import { captureScrollState, restoreScrollState } from "./events/scroll-state.js?v=20260923-reservation-requests-r1";
...
const reactAdminActions = {
  async setAdminView(view, filters = {}) {
    ...
    renderWithScrollState(scrollState);
    try {
      const nextFilters = view === "reservations" ? { from: "", to: "", time: "", dateBasis: "reserved", semester: "all", ...filters } : filters;
