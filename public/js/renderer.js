...
import { adminShell } from "./views-admin.js?v=20260627-admin-scroll-blur";
import { authView, noticeBottomSheet, studentShell, warningPopup } from "./views-student.js?v=20260627-admin-scroll-blur";
