...
import { adminShell } from "./views-admin.js?v=20260626-admin-dashboard-visual-grid";
import { authView, noticeBottomSheet, studentShell, warningPopup } from "./views-student.js?v=20260626-admin-dashboard-visual-grid";
